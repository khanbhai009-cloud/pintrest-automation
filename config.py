...
CEREBRAS_VISION_MODEL = "qwen-3-235b-a22b-instruct-2507"
VISION_RETRY_DELAY    = 10   # seconds between fallback attempts
CEREBRAS_MODEL        = "llama3.1-8b"
CEREBRAS_CMO_MODEL    = "llama3.1-8b"
GEMINI_CMO_MODEL      = "gemini-2.5-flash"
